 ...
 *
 */
var ZTextFieldDiv = (function () {
    // word-break:break-all;width:100%,height:100%
    function ZTextFieldDiv() {
    ...
    Object.defineProperty(ZTextFieldDiv.prototype, "x", {
        set: function (num) {
    ...
    Object.defineProperty(ZTextFieldDiv.prototype, "y", {
        set: function (num) {
    ...
    Object.defineProperty(ZTextFieldDiv.prototype, "text", {
        set: function (str) {
    ...
    Object.defineProperty(ZTextFieldDiv.prototype, "size", {
        set: function (num) {
    ...
    Object.defineProperty(ZTextFieldDiv.prototype, "visible", {
        set: function (b) {
            if (b) {
    ...
    ZTextFieldDiv.prototype.resizeText = function (w, h, str) {
    ...
    ZTextFieldDiv.prototype.checkEndText = function (str, spine, h) {
    ...
    ZTextFieldDiv.prototype.checkTextHeight = function (text, spine, h, ret) {
        while (true) {
    ...
    ZTextFieldDiv.prototype.checkHTML = function (child, h, ret) {
    ...
    return ZTextFieldDiv;
}());
__reflect(ZTextFieldDiv.prototype, "ZTextFieldDiv");
//# sourceMappingURL=ZTextFieldDiv.js.map